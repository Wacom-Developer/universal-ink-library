...
if __name__ == '__main__':
    ...
    ink_model: InkModel = parser.parse(Path(__file__).parent / '..' / 'ink' / 'uim_3.0.0' /
                                       '1) Value of Ink 1.uim')
    ...
    ink_model: InkModel = parser.parse(Path(__file__).parent / '..' / 'ink' / 'uim_3.1.0' /
                                       '1) Value of Ink 1 (3.1 delta).uim')
    # Save the model, this will overwrite an existing file
    ...
    ink_model_2: InkModel = parser.parse(Path(__file__).parent / '..' / 'ink' / 'will' / 'elephant.will')
    # Save the model, this will overwrite an existing file
