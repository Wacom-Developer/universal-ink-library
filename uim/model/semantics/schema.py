...
class BaseSchema:
    ...
    # -------------------------------------------- Properties ----------------------------------------------------------
    HAS_SCHEMA_INCLUDE: str = "hasSchemaInclude"
    HAS_ROOT: str = "hasRoot"
    HAS_CHILD: str = "hasChild"
    HAS_PARENT: str = "hasParent"
    HAS_REPRESENTS_VIEW: str = "representsView"
    HAS_GENERATED_BY: str = "generatedBy"
    HAS_PARENT_INK_MODEL: str = "hasParentInkModel"
    HAS_STROKE: str = "hasStroke"
...
class SimplifiedSegmentationSchema(BaseSchema):
    ...
    HAS_CONTENT_SCORE: str = "hasContentScore"
    HAS_ALT_CONTENT: str = "hasAltContent"
    HAS_ALT_CONTENT_SCORE: str = "hasAltContentScore"
    HAS_LANGUAGE: str = "hasLanguage"
    HAS_DIRECTION: str = "hasDirection"
    HAS_CATEGORY_HINT: str = "categoryHint"
...
class SegmentationSchema(BaseSchema):
    ...
    HAS_MATHML: str = "hasMathML"
    HAS_ASCII_MATH: str = "hasASCIIMath"
    HAS_ENTITY_LABEL: str = "hasEntityLabel"
    HAS_ENTITY_TYPE: str = "hasEntityType"
    HAS_IS_STRUCTURAL_ENTITY: str = "isStructuralEntity"
    HAS_IS_BASE_ENTITY: str = "isBaseEntity"
    HAS_BULLET: str = "bullet"
    HAS_BODY: str = "body"
    HAS_MARKING_TYPE: str = "markingType"
    HAS_ANNOTATES: str = "annotates"
    HAS_CONNECTOR_TYPE: str = "connectorType"
    HAS_CONNECTS: str = "connects"
    HAS_CORRECTION_TYPE: str = "correctionType"
    HAS_SOURCE: str = "source"
    HAS_MODIFIER: str = "modifier"
...
class NamedEntityRecognitionSchema(SegmentationSchema):
    ...
    HAS_IS_PART_OF_NAMED_ENTITY: str = "isPartOfNamedEntity"
    HAS_URI: str = "hasUri"
    HAS_IRI: str = "hasIri"
    HAS_URN: str = "hasUrn"
    HAS_UNIQUE_ID: str = "hasUniqueId"
    HAS_IS_REFERENCE: str = "isReference"
    HAS_PART: str = "hasPart"
    HAS_CREATION_DATE: str = "hasCreationDate"
    HAS_EXPIRATION_DATE: str = "hasExpirationDate"
    HAS_LABEL: str = "hasLabel"
    HAS_LANGUAGE: str = "hasLanguage"
    HAS_PROVIDER: str = "hasProvider"
    HAS_SOURCE: str = "hasSource"
    HAS_CONFIDENCE: str = "hasConfidence"
    HAS_NORM_CONFIDENCE: str = "hasNormConfidence"
    HAS_ABSTRACT_TEXT: str = "hasAbstractText"
    HAS_ARTICLE_URL: str = "hasArticleUrl"
    HAS_WEBSITE_URL: str = "hasWebsiteUrl"
    HAS_IMAGE_URL: str = "hasImageUrl"
    HAS_THUMBNAIL_URL: str = "hasThumbnailUrl"
    HAS_PROVIDED_ENTITY_TYPE: str = "hasProvidedEntityType"
    HAS_PROVIDED_CATEGORY: str = "hasProvidedCategory"
    HAS_PROVIDED_ONTOLOGY_TYPE: str = "hasProvidedOntologyType"
...
class PartOfSpeechSchema(SegmentationSchema):
    ...
    # -------------------------------------------- Properties ----------------------------------------------------------
    HAS_POS_ENTITY: str = "hasPOSEntity"
    HAS_IS_PART_OF_POS_ENTITY: str = "isPartOfPOSEntity"
    HAS_PART: str = "hasPart"
    HAS_TAG: str = "hasTag"
...
class MathStructureSchema(SegmentationSchema):
    ...
    HAS_OPENING_BRACKET: str = "openingBracket"
    HAS_CLOSING_BRACKET: str = "closingBracket"
    HAS_INDEX: str = "index"
    HAS_RADICAL_SYMBOL: str = "radicalSymbol"
    HAS_RADICAND: str = "radicand"
    HAS_BODY: str = "body"
    HAS_NUMERATOR: str = "numerator"
    HAS_DENOMINATOR: str = "denominator"
    HAS_FRACTION_LINE: str = "fractionLine"
    HAS_FRACTION_TYPE: str = "fractionType"
    HAS_SUBSCRIPT: str = "subScript"
    HAS_SUPERSCRIPT: str = "superScript"
    HAS_PRE_SUPERSCRIPT: str = "preSuperScript"
    HAS_PRE_SUBSCRIPT: str = "preSubScript"
    HAS_UNDERSCRIPT: str = "underScript"
    HAS_OVERSCRIPT: str = "overScript"
    HAS_ROWS: str = "rows"
    HAS_MATRIX_TYPE: str = "matrixType"
    HAS_OPERATION_TYPE: str = "operationType"
    HAS_REPRESENTATION: str = "representation"
    HAS_SYMBOL_TYPE: str = "symbolType"
    HAS_SEPARATOR_TYPE: str = "separatorType"
